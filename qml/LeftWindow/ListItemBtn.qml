    ...
    background: Rectangle{
        ...
        MouseArea{
            ...
            onEntered: {
                if(!isClicked)
                {
                    btnSymbol.color="#dcdde3";  // hover高亮色
                    btnName.color="#dcdde3";    // hover高亮色
                }
            }
            ...
            onExited: {
                if(!isClicked)
                {
                    btnSymbol.color="#adafb2";      // 默认低亮色
                    btnName.color="#adafb2";        // 默认低亮色
                }
            }
            ...
            onClicked: {
                isClicked=true;
                rect1.visible=true;
                parent.color="#26282c";     // hover高亮色
                btnClicked(idName)          // 发射信号
            }
        }
    }
