...
Rectangle{
    property bool bLocalMode: true   // false为网络播放，true为本地播放
    id:bottomWd
    color:"#222225"
    width: parent.width
    height: 60*dp
...
//    }
    ...
    MediaPlayer{
        ...
        onPlaying: {
            playBtn.state="play";
            bottomWd.bLocalMode=false;
            //timer.start();
        }
        onStopped: {
            if(!bottomWd.bLocalMode)
                playBtn.state="pause";
            //timer.stop();
        }
        onSourceChanged: {
...
//                AudioData.nextSong();
    ...
    SliderPlay{   // 进度条
        ...
        height: 15*dp
        showColor:"#247BA0"
        workedBarColor: "#FF1654"
        unworkedBarColor:"#171719"
        anchors.left: parent.left
...
//                AudioData.nextSong();
    ...
    Label{   // 音量按钮
        ...
        MouseArea{
            ...
            onClicked: {
                ...
                volumeSliderBG.visible = !volumeSliderBG.visible
            }
        }
    }
    ...
    Rectangle{
        ...
        anchors.horizontalCenter:  volumeLabel.horizontalCenter
        ...
        Label{
            ...
            anchors.bottom: volumeSliderBG.bottom
            anchors.bottomMargin: 5*dp
            anchors.horizontalCenter: volumeSliderBG.horizontalCenter
        }
        ...
        SliderPlay{    // 音量滑动条
            ...
            hasParent:true
            width:30*dp
            height:parent.height-volumeValue.height-5*dp//100*dp
            showColor:"#247BA0"
            workedBarColor: "#FF1654"
            unworkedBarColor:"#171719"
            anchors.bottom: volumeValue.top
            anchors.horizontalCenter: parent.horizontalCenter
//            anchors.bottom: volumeLabel.top
//            anchors.left: volumeLabel.left
//            anchors.bottomMargin: 10*dp
    //        anchors.leftMargin: 3*dp
            isHorizonal: false
            minValue: 0
    ...
    Image {
        ...
        height: 22*dp
        width: 22*dp
        source: "qrc:/images/soundeffect.png"
        ...
        MouseArea{
            ...
            onEntered: {
                parent.source="qrc:/images/soundeffect_hover.png"
                parent.ishovered=true
            }

            onExited: {
                parent.source="qrc:/images/soundeffect.png"
                parent.ishovered=false
            }
            ...
            onClicked: {
                if(bottomWd.bLocalMode)
                {
                    soundEffect.visible=!soundEffect.visible
    ...
    Rectangle{   // 播放列表
        ...
        width: 40*dp;
        height: 20*dp;
        anchors.left: soundEffectLabel.right;
        anchors.leftMargin: 15*dp;
        anchors.verticalCenter: parent.verticalCenter;
        ...
        MouseArea{
            ...
            onEntered: {
                playList.source="qrc:/images/list_lyric(2).png";
                parent.ishovered=true;
            }

            onExited: {
                playList.source="qrc:/images/list_lyric(1).png";
                parent.ishovered=false;
            }
...
//    }
    Rectangle{
        ...
        function updateInfo(_title,_album,_artist){
            title=_title.length===0?qsTr("未知标题"):_title
            album=_album.length===0?qsTr("未知专辑"):_album
            artist=_artist.length===0?qsTr("未知歌手"):_artist
        }
        ...
        function changeSource(){
            loader.setsource("qrc:/qml/SpectrumWindow/MiniWindow.qml")
        }
...
//        }
        ...
        Grid{
            ...
            Label{    // 在这里已经指定了Grid布局的情况下，剩下的所有组件都不需要指定anchors，直接按顺序写，注明大小即可！
                text:qsTr("速度");
                font{
